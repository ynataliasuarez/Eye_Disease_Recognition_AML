...
if __name__ == '__main__':
    ...
    quality = 100
    source_folder = r'/media/user_home2/ynsuarez/AML/Proyecti/ODIR-5K/Testing_Images_cropped'
    destination_folder = r'C:/media/user_home2/ynsuarez/AML/Proyecti/ODIR-5K/Testing_Images_treated' + '_' + str(image_width)
    # create logger
