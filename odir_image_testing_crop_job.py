...
if __name__ == '__main__':
    ...
    source_folder = r'/media/user_home2/ynsuarez/AML/Proyecti/ODIR-5K/Testing Images'
    destination_folder = r'/media/user_home2/ynsuarez/AML/Proyecti/ODIR-5K/Testing_Images_cropped'
    # create logger
